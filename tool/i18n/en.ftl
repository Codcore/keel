...
generated-guest-taken = { $file } — this file is yours, and keel wrote nothing into it: it is not what this release writes. Nothing here is deleted or moved. If you want the loop's hook, paste these entries into it yourself:
{ $snippet }
