...
check-scope-skipped-not-wave = scope not compared: branch "{ $branch }" is not named as any wave (§8.2) -- said aloud, not painted green
check-scope-skipped-no-git = scope not compared: git names no branch here -- said aloud, not painted green
...
check-unchecked = not yet checked: scenario revisions in test tags (§5.5, §7.5), tag deltas (§7.15), closure (§6.5), contracts holding (§7.6), header-vs-body (§7.7) -- rungs ahead
