...
adapter-rspec-tmp-instead = the directory must be new and this run's own -- something already stands under that name in the system's temp dir; remove it or change TMPDIR and retry
