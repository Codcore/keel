...
graph-crossing = the file "{ $file }" is declared by two open waves -- { $first } and { $second } -- with no depends_on edge between them: their scopes cross, and a crossing between independent waves is a question at planning time (§8.8)
