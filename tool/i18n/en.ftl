...
next-step-light-contract-chores = step: the branch of wave { $wave } changes the contract "{ $contract }" and the wave does not name it: name it among the files of a transform -- the wave is then full (§6.8; §2.11: a contract is worth two human looks), plan apart and work apart; or take the change off the branch
