...
close-check-red = the documents court stopped this run: { $count } findings of `keel check` on this branch's own files (§7.1-§7.9, chapter 4) -- the battery did not run, because a court that costs six seconds answers before one that costs minutes
