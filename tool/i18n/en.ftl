...
close-check-red-plan-instead = instead: nothing to do today -- these say the work has not begun, and a plan PR merges as a plan (§6.6). They come back as blockers on the work branch, which is where they are answered
