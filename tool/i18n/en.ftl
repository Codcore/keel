...
check-method-row = the methodology of this keel binary, in both tongues (chapters and paragraph numbers)
...
speak-method-numbers = the { $lang } methodology and the { $other } one number their paragraphs differently, first at { $at }
