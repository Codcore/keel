...
adapter-elixir-name-not-text-instead = the runner was told `-kernel standard_io_encoding unicode`, and this project's own ELIXIR_ERL_OPTIONS came first and won. Take the encoding word out of it, or give the run a UTF-8 locale
