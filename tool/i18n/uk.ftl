...
adapter-ruby-unmarked = звіт minitest не має кінця: у "{ $file }" minitest сказав свій підсумок, а мітки, якою keel закриває його звіт, у виводі нема. Мітку друкує гак `Minitest.after_run`, який keel ставить ОСТАННІМ і який тому спрацьовує ПЕРШИМ — одразу по звіту; без неї не видно, де кінчаються слова minitest і починаються чужі
adapter-ruby-unmarked-instead = хтось між minitest і keel переписує потік — власний репортер, плагін або `at_exit`, що підміняє STDOUT і не повертає його. Прожени файл рукою і подивись, чи доходить останній рядок; читати такий потік далі keel не стане
