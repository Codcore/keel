...
status-wave-closed-light = { "  " }{ $wave } — доводити нема чого: обіцянок у ній нема, тож закрита фактом merge (§2.11)
status-wave-light-own = { "  " }{ $wave } — доводити нема чого: обіцянок у ній нема, тож закриється фактом merge (§2.11)
