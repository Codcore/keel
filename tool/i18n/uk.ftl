...
close-check-red = суд документів спинив цей прогін: { $count } знахідок `keel check` на власних файлах цієї гілки (§7.1–§7.9, глава 4) — батарея не бігла, бо суд ціною в шість секунд відповідає раніше за суд ціною в хвилини
