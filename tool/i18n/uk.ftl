...
close-check-red = суд документів спинив цей прогін: { $count } знахідок `keel check` (§7.1–§7.9, глава 4) — батарея не бігла, бо суд ціною в шість секунд відповідає раніше за суд ціною в хвилини
close-check-red-instead = натомість: полагодь названі вище файли і повтори keel close; те саме окремо й повністю каже keel check
