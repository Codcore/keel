...
check-scope-base-first = перший commit гілки @ { $sha } (стовбура — main чи master — тут нема)
...
limit-no-trunk = не перевірено: стовбура main цей клон не знає, тож точки розгалуження нема — зникнення документів (§4.12) і код на план-гілці (§4.9) не судились; назви стовбур main або принеси origin/main
