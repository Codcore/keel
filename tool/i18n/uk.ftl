...
check-trunk-refused = стовбур: { $trunk } — узято без відповіді git-а. git називає { $refused }, а це гілка РОБОТИ — план, spike або гілка, що несе власний файл хвилі (§8.2, §4.13), — і стовбуром гілка роботи не буває. Так називає клон, знятий із робочого дерева. Якщо взятий вище стовбур — не та гілка, назви його в keel.toml (trunk = "...", кореневий ключ, ДО [trust] і [generated])
check-trunk-refused-alone = стовбура не знайти. git називає { $refused }, а це гілка РОБОТИ — план, spike або гілка, що несе власний файл хвилі (§8.2, §4.13), — і стовбуром гілка роботи не буває. Так називає клон, знятий із робочого дерева. Назви стовбур у keel.toml (trunk = "...", кореневий ключ, ДО [trust] і [generated])
