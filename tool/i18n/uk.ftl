...
briefing-hygiene =
    ГІГІЄНА (без цього рецензія не рахується):
      ...
      • власний бінарник із гілки, яку рецензуєш, а не встановлений;
...
briefing-work =
    ЩО ЗРОБИТИ:
      ...
      • зіграй контрфакти: зніми по одному асерту або рядку суду і
        ...
        обіцянка, а не суд;
      • пошукай хибні спрацювання там, де автор не дивився;
      • назви межі, яких хвиля не назвала.
briefing-questions =
    ЧОТИРИ ПИТАННЯ (§9.9):
      1. Про що автор змовчав?
      2. Чи не ламається план? Чого бракує в сценарії проти того, що
         жене проба?
      3. Чи реалізовано обіцяне — і чи не звужено?
      4. Чи покриті кути?
briefing-report =
    ЗВІТ лягає у keel/reviews/{ $wave }.md і містить: дату, хто,
    ВИРОК (прийняти / прийняти з зауваженнями / повернути на
    доробку); «Жива механіка» з числами; знахідки R-1, R-2, … з вагою
    і ДОКАЗОМ; «Не знайшов»; чотири питання стисло; власні промахи.
    Числа — ТІЛЬКИ з бігів; чого не зміг — так і напиши «не зміряв» і
    чому. Без цього файлу keel close тримає хвилю відкритою.
