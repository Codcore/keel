...
close-check-red-plan = суд документів каже своє: знахідок `keel check` на власних файлах цієї гілки (§7.1–§7.9, глава 4) — { $count }, з них полічено блокерами — { $counted }. Хвиля цієї гілки затверджена і не почата, а суд ГІЛКИ (§4.1, §4.4–§4.6, §6.2, §6.3, §7.5) там каже одне: робота ще не починалась — той самий стан, який оголошує звіт нижче. Тому вони друкуються і не лічаться, і план зливається як план (§6.6). Кожен інший суд лічиться тут так само, як деінде
