...
check-checked-scope = scope гілки, що зветься як хвиля (§4.1, §4.4–§4.6, §4.8; поза порівнянням, як меблі: keel/, keel.toml, згенеровані файли у формі цього релізу і lock-файл мови, який лишає її бігун)
