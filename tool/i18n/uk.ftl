...
check-chores-heavy-withdraws = знімає сценарій
...
close-awaiting-merge-unseen = { $wave }: легка — самі chore, закриється фактом merge (§6.5): main тут нема, факту merge суд не бачить
...
status-wave-light-unseen = { "  " }{ $wave } — доводити нема чого: обіцянок у ній нема, тож закриється фактом merge (§6.5): main тут нема, факту merge не видно
