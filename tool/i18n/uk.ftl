...
adapter-elixir-name-not-text-instead = бігунові сказано `-kernel standard_io_encoding unicode`, але власне ELIXIR_ERL_OPTIONS цього проєкту стоїть першим і виграло. Прибери звідти слово про кодування або дай прогонові UTF-8-локаль
