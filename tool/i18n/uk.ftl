...
close-said-of-files = — що сказали бігуни, доки бігли ці { $count } файли, дослівно і без маскування, і текст у них один і той самий: { $files }
close-said-outside = — і те, що бігун сказав поза будь-якою ціллю: cargo жене всі цілі одним процесом, і в його stderr вони пишуть по черзі, тож цей текст не належить жодному файлу — але це теж слова, які зробили батарею червоною (звідти говорить процес-дитина тесту, а не сам тест):
close-test-said-run = (біг { $run } із { $runs })
close-test-said-nothing = — і бігун не сказав нічого, що цей суд міг би зберегти: під цим червоним його голос порожній. Жодна з шести доріг цього не робить — рядок стоїть на випадок руки, яка віддасть червоне без слів, щоб замість слів не стояла порожнеча
