...
close-check-red-plan-instead = натомість: сьогодні робити нічого — вони кажуть, що робота ще не починалась, а план зливається як план (§6.6). Вони повернуться блокерами на робочій гілці, де на них і відповідають
