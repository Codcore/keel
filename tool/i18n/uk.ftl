...
adapter-ruby-roll-lost = перелік розбито: у "{ $file }" цей читач нарахував місць, де вирок не склався — { $count }. Так буває, коли тест друкує рядок, що сам виглядає як час і мітка: тоді тест може закрити САМ СЕБЕ зеленим, а його справжній вирок піде на смітник — і всі числа при цьому зійдуться. Зелене, здобуте так, гірше за червоне (§4.10)
