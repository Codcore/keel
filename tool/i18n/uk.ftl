...
review-plan-why = сорок відповідей пишуться тут, а свіже око приходить аж на закритті — коли робота вже зроблена під цей план. Машина ловить ВІДСУТНІСТЬ відповіді; неправду в ній ловить лише читач. Нижче — не весь план, а місця, де неправда живе найчастіше
...
review-plan-footer = кожне питання вище — «так чи ні, і чому». Відповідає людина або свіжий агент; інструмент лише каже, де дивитись
...
next-plan-branch = крок: це план-гілка хвилі { $wave } (§8.3) — доведи повноту плану (keel check, мапа), тоді дай план свіжому оку: `keel review` тут збирає пакет ПЛАНУ і каже, які відповіді перечитати перед злиттям (§9.9); далі зливай план-PR, а робота поїде гілкою "{ $wave }"
