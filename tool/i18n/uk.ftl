...
limit-no-trunk = не перевірено: стовбура main цей клон не знає, тож точки розгалуження нема — зникнення документів (§4.12) і код на план-гілці (§4.9) не судились; назви стовбур у keel.toml (trunk = "...") або принеси ту гілку з віддаленого
