...
close-test-said-run = — що сказав бігун, доки біг цей файл, дослівно і без маскування (біг { $run } із { $runs }):
close-test-said-nothing = — і бігун не сказав нічого, що цей суд міг би зберегти: падіння він надрукував не там, де keel його бачить. Це не тихе червоне, це червоне, чиї слова деінде — бігун, якому веліли їх ховати (`--tb=no` у pytest), або репортер, що пише їх у власний файл
