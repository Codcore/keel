...
generated-guest-taken = { $file } — цей файл ваш, і keel не написав у нього нічого: він не є тим, що пише цей реліз. Ніщо тут не видаляється й не рухається. Якщо hook лупа потрібен — вставте ці записи самі:
{ $snippet }
