...
close-closed-light = { $wave }: закрита (легка) — самі chore, закрита фактом merge (§6.5): файл хвилі стоїть у main
close-awaiting-merge = { $wave }: легка — самі chore, закриється фактом merge (§6.5): файла хвилі в main ще нема, merge і є закриття
close-awaiting-merge-unseen = { $wave }: легка — самі chore, закриється фактом merge (§6.5): стовбура (main чи master) тут нема, факту merge суд не бачить
...
status-wave-closed-light = { "  " }{ $wave } — доводити нема чого: обіцянок у ній нема, тож закрита фактом merge (§6.5): файл хвилі стоїть у main
...
status-wave-light-unseen = { "  " }{ $wave } — доводити нема чого: обіцянок у ній нема, тож закриється фактом merge (§6.5): стовбура (main чи master) тут нема, факту merge не видно
