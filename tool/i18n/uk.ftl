...
check-method-row = методика цього бінарника keel, обома мовами (розділи і номери параграфів)
...
speak-method-numbers = методики мовами { $lang } і { $other } нумерують параграфи по-різному, вперше на { $at }
