...
graph-crossing = файл "{ $file }" оголошують дві відкриті хвилі — { $first } і { $second } — а ребра depends_on між ними нема: їхні scope перетинаються, а перетин між незалежними хвилями — питання ще на плануванні (§8.8)
...
check-wave-cancelled = не судиться: хвилю { $wave } скасовано — { $why } (§6.3-а)
