...
adapter-elixir-not-utf8 = бігун elixir надрукував імена тестів не текстом: у виводі стоять знаки заміни або екранні послідовності замість літер, тож імʼя не звірити з тим, що у файлі — а суд, який його прочитав би, сказав би, що батарея пропустила тест, який вона виконала
adapter-elixir-not-utf8-instead = дай бігунові друкувати unicode: прибери ERL_FLAGS=+pc latin1 або дай прогонові UTF-8-локаль (LANG=en_US.UTF-8). keel дописує `+pc unicode` сам, але явний latin1 його перебиває
