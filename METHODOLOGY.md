...
> disagree, the Ukrainian one is right and this one is corrected. The
> translation records the revision it was made from, and a stale record is
...
silence is forbidden at the level of the field. A cut that is in nobody's `covers` and in no `decisions` means
