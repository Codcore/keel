...
скіл. Довідник лишається вдома, у репозиторії методики.

**Розрізи — виняток, і навмисний.** Файл у проєкті сам собою нічого не змушує:
змушують чотири речі — `AGENTS.md`, який читається завжди, хук старту сесії, хук
перед записом файлу і скіл, що вантажиться при плануванні. Тому `keel/QUALITY.md`
лежить копією, а показує на нього скіл планування: розрізи проходять пунктами
саме там, де пишуться сценарії. Файл, на який ніщо не показує, — мертвий.
...
| `keel init` | ставить Keel у проєкт: теки, копію інструмента, розрізи, `AGENTS.md`, CI, хуки |
