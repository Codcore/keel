...
class TestCiCommand(ProjectCase):
    ...
    def test_it_does_not_run_when_asked_not_to(self):
        problems, note = self.verdict("false", run=False)
        self.assertEqual(problems, [])
        self.assertIsNone(note)
