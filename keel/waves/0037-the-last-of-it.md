...
Межа сказана вголос: випадок, коли сама хірургія відмовляє (файл не
читається чи не пишеться), проба не грає — від root у контейнері права
не тримають, а інші причини перехоплює читання документів раніше і
відмовляє всією командою. Код виходу для нього побудований і
читається з коду, але не зміряний.
