...
переїзд між теками — знахідка. Де історію обрізано або стовбура цей
клон не знає, суд каже «не перевірено» замість зеленого; а де git
нема зовсім — це не клон із бідою, це не клон, і його ні про що не
питають (§7.9, школа 0031 R-8).
