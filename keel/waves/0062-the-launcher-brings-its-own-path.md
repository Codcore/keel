...
transforms:
  ...
  journal:
    ...
    files:
      ...
      - BACKLOG.md
      - keel/reviews/0062-the-launcher-brings-its-own-path.md
decisions:
...
Звіт свіжого рецензента (§9.9) у історію гілки; стаття журналу; знятий
рядок боргу, який ця хвиля сплатила.
