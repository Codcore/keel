...
transforms:
  ...
  journal:
    chore: "запис хвилі: звіт свіжого рецензента, стаття журналу і рядок черги про cat-file --batch (§4.11)"
    files:
      - docs/uk/V2-PROCESS.md
      - BACKLOG.md
      - keel/reviews/0061-the-court-asks-git-once.md
decisions:
...
Звіт свіжого рецензента (§9.9) у історію гілки; стаття журналу; рядок
черги про `cat-file --batch`, обіцяний у Why і не покладений.
