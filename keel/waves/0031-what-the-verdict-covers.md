...
decisions:
  ...
  performance.time-behaviour: "свідомо без тесту: одне ls-remote на вирок; мережа може бути повільна, тож суд запушеності НЕ блокує вирок і має межу часу"
  ...
  reliability.fault-tolerance: "тримає a-verdict-says-how-much-of-it-is-real: нема мережі — суд запушеності каже «не знаю» і НЕ червонить вирок; це межа, а не відмова"
  reliability.recoverability: "не застосовується"
  security.confidentiality: "свідомо без тесту: ls-remote читає лише імена гілок origin, який уже налаштований у клоні"
...
дістати повний вирок. Нема мережі — суд запушеності каже «не знаю» і
вироку не червонить: межа, а не відмова.
