...
decisions:
  ...
  interaction.self-descriptiveness: "свідомо без нового тесту: кожен hook-конфіг несе в собі рядок, що він згенерований — у формі, яку дозволяє JSON того інструмента"
...
Валідатор `claude plugin validate` — soft-суддя: там, де бінарника
