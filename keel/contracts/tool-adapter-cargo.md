...
- cargo викликається як команда системи; його відмова — відмова
  вголос. Кожен біг ізолюється від успадкованого CARGO_TARGET_DIR:
  спільний кеш цілей зсуває вироки на чужі (бачено живцем рецензіями
  0006 і 0008), тож судимий проєкт збирається у власну теку target.
