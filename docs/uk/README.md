...
| `keel gaps [крок]` | чого бракує в описі кроку: слаги без секцій, трансформи без файлів, сценарії без `proves`. І питає про забуте ребро: крок оголошує файл, який оголошує й інший крок, а `depends_on` його не називає |
