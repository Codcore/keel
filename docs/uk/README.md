...
`lang` вирішує ще й те, якою мовою говорить сам інструмент. Його повідомлення
ключуються англійським текстом, тож пропущений переклад дає читабельну
англійську, а не помилку. Командний рядок в обох випадках лишається англійським:
