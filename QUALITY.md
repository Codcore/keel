...
Девʼять розрізів, якими проходить кожен крок, і файл, на який Keel показує,
коли каже «пройди розрізи».
...
**Двічі, і з різними питаннями.**

**Коли крок описується** — там, де пишуться сценарії. Кожен розріз питається про
те, що планується, і те, що він виявляє, стає сценарієм або рішенням.

**Перед pull request** — питання інше: не «що ще має бути правдою», а «про що ми
промовчали». Знайдене закривається до PR, як і будь-що інше.

**Один прохід на крок.** Не на кожному рівні й не до збіжності: рівнів у Keel
немає, є крок.
