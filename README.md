...
| `keel gaps` | чого бракує в описі кроку: слаги без секцій, трансформи без файлів, сценарії без `proves` |
...
| `keel init` | ставить Keel у проєкт: теки, копію інструмента, довідники, `AGENTS.md`, CI, хуки. `--docs` і `--lang` задають мови |
